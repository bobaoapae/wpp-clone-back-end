...
import br.com.zapia.wpp.api.model.handlersWebSocket.AbstractFindChatHandler;
...
@Component
@Scope("usuario")
public class FindChatHandler extends AbstractFindChatHandler<WebSocketRequestSession> {
