...
import br.com.zapia.wpp.api.model.handlersWebSocket.AbstractGetAllChatsHandler;
...
@Component
@Scope("usuario")
public class GetAllChatsHandler extends AbstractGetAllChatsHandler<WebSocketRequestSession> {
