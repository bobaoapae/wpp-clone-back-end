...
import br.com.zapia.wpp.api.model.handlersWebSocket.AbstractSubscribePresenceHandler;
...
@Component
@Scope("usuario")
public class SubscribePresenceHandler extends AbstractSubscribePresenceHandler<WebSocketRequestSession> {
