...
import br.com.zapia.wpp.api.model.handlersWebSocket.AbstractMarkComposingHandler;
...
@Component
@Scope("usuario")
public class MarkComposingHandler extends AbstractMarkComposingHandler<WebSocketRequestSession> {
