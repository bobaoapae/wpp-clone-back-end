...
import br.com.zapia.wpp.api.model.handlersWebSocket.AbstractMarkReadHandler;
...
@Component
@Scope("usuario")
public class MarkReadHandler extends AbstractMarkReadHandler<WebSocketRequestSession> {
