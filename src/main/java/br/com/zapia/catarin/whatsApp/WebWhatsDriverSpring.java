...
import br.com.zapia.catarin.authentication.scopeInjectionHandler.UsuarioContextThreadPoolExecutor;
import br.com.zapia.catarin.authentication.scopeInjectionHandler.UsuarioContextThreadPoolScheduler;
...
public class WebWhatsDriverSpring {
    ...
    public WebWhatsDriver initialize(JPanel panel, String profilePath, Runnable onConnect, ActionOnNeedQrCode onNeedQrCode, ActionOnErrorInDriver onError, ActionOnLowBattery onLowBaterry, Runnable onSmarthphoneDisconnect, ActionOnChangeEstadoDriver onChangeEstadoDriver) throws IOException {
    ...
    private class WebWhatsDriverSpringIntern extends WebWhatsDriver {
        ...
        @Override
        protected ExecutorService getExecutorServiceInterno() {
            return new UsuarioContextThreadPoolExecutor(usuario, 0, Integer.MAX_VALUE,
